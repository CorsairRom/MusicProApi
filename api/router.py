...
from api.views import ProductoViewSet,ProductoWithStockViewSet,PedidosWithStockViewSet,DetallePedidorViewSet
...
router.register(r'pedidos', PedidosWithStockViewSet, basename="pedidos")
